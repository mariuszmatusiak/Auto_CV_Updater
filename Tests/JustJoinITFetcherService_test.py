...
import pytest, os
from Core.Fetchers.JustJoinIT.JustJoinITFetcherService import JustJoinITFetcherService, DEFAULT_COOKIE_FILE
import User

class TestJustJoinITFetcherService:
    ...
    def test_CreateLinkedInFetcherServiceObject(self):
        fetcherService = JustJoinITFetcherService(username="aaa", password="bbb")
        assert fetcherService is not None
